...
class Scantest extends StatefulWidget {
  final String mode;
  const Scantest({Key? key, required this.mode}) : super(key: key);
  @override
...
class _ScantestState extends State<Scantest> {
  ...
  void initState() {
    super.initState();
    type = AppStateNotifier.instance.scandata!["classType"] % 10;
    if (type >= 8) {
      type = type - 2;
    }
    print(type);
        ...
        DraggableScrollableSheet(
          ...
          builder: (BuildContext context, ScrollController scrollController) {
            return Consumer<AppStateNotifier>(builder: (context, AppStateNotifier, child) {
              ...
              typeManager.setType(context, type);
              return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      (AppStateNotifier.scandata!['accuracy'].toString() ?? 'na') + '%',
                                                      style: AppFont.b24.overrides(fontSize: 20),
                                                    ),
                                                  )
                                                ],
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets.only(top: 12),
                                                    child: Text(
                                                      (AppStateNotifier.scandata?["weight"].toString() ?? 'na') + 'kg',
                                                      style: AppFont.b24.overrides(fontSize: 20),
                                                    ),
                                                  )
                                                ],
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ToggleImageSwitch(mode: 'tester', type: type),
                            ],
                          ),
                        ),
                        if (type != 0) ...[
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: LodingButtonWidget(
                onPressed: () async {
                  context.goNamed('Teseter_Scan', extra: 2);
                },
