...
class CreateCodeWidget extends StatefulWidget {
  const CreateCodeWidget({Key? key}) : super(key: key);

  @override
  _CreateCodeWidgetState createState() => _CreateCodeWidgetState();
}

class _CreateCodeWidgetState extends State<CreateCodeWidget> {
