...
class _GroupInfoScreenState extends State<GroupInfoScreen> {
  ...
  Widget build(BuildContext context) {
    String groupLeaderName = '${groupData['responseUserFirstName']} ${groupData['responseUserLastName']}';
    // int numberOfGroupMembers = groupData['data']['numberOfGroupMembers'];
    String invitationId = groupData['invitationId'];
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: LodingButtonWidget(
                          onPressed: () async {
                            GroupApi.createGroupInvitation(widget.code).then((value) => value
                                ? showAlignedDialog(
                                    context: context,
                                    isGlobal: true,
                                    avoidOverflow: false,
