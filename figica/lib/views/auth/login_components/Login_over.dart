...
class LoginOverWidget extends StatefulWidget {
  final VoidCallback onConfirmed;
  final String message;
  const LoginOverWidget({Key? key, required this.onConfirmed, required this.message}) : super(key: key);

  @override
  _LoginOverWidgetState createState() => _LoginOverWidgetState();
}

class _LoginOverWidgetState extends State<LoginOverWidget> {
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      SetLocalizations.of(context).getText(
                        'completeLoginButtonFindPasswordLabel' /* Hello World */,
                      ),
                      style: AppFont.s18,
                    ),
                  ),
                  if (widget.message == "phone")
                    Text(
                      SetLocalizations.of(context).getText(
                        'popupErrorLoginLabel6' /* Hello World */,
                      ),
