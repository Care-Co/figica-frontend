...
class cancelinvite extends StatefulWidget {
  const cancelinvite({
    Key? key,
  }) : super(key: key);

  @override
  _cancelinviteState createState() => _cancelinviteState();
}

class _cancelinviteState extends State<cancelinvite> {
  @override
