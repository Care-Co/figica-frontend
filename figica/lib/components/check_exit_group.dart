...
class CheckExit extends StatefulWidget {
  const CheckExit({Key? key}) : super(key: key);

  @override
  State<CheckExit> createState() => _CheckExitState();
}

class _CheckExitState extends State<CheckExit> {
  @override
