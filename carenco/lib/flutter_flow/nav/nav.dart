...
class AppStateNotifier extends ChangeNotifier {
  CarencoFirebaseUser? initialUser;
  CarencoFirebaseUser? user;
  ...
  void update(CarencoFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => SignupPageWidget(
            authentication:
            params.getParam('authentication', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'Id_Verification',
          path: 'idVerification',
          builder: (context, params) => IdVerificationWidget(
        ...
        FFRoute(
          name: 'infomation',
          path: 'infomation',
          builder: (context, params) => InfomationWidget(),
        ),
        FFRoute(
          name: 'MainPage',
          path: 'mainPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => SignupPage2Widget(
            emailstring: params.getParam('emailstring', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'sms_certification',
          path: 'smsCertification',
          builder: (context, params) => SmsCertificationWidget(),
        ),
        FFRoute(
          name: 'pass_page',
          path: 'passPage',
